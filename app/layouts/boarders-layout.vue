    ...
    >
      ...
      <div class="flex items-center justify-center p-4 border-b border-slate-200/60 bg-gradient-to-r from-green-600 to-green-400">
        <div v-if="isOpen" class="flex items-center gap-2 whitespace-nowrap">
          ...
          <div>
            <h1 class="text-lg font-bold text-white">Three's Maria's</h1>
          </div>
        </div>
              ...
              <template #activator="{ props }">
                ...
                >
                  <div class="text-right">
                    ...
                    <p class="text-xs text-slate-500 text-center">Boarders</p>
                  </div>
                  <div class="relative">
                ...
                <v-card-text class="p-1">
                  <v-list dense class="p-0">
                    ...
                    <v-list-item :ripple="false" class="hover:bg-slate-50 px-2 py-1 cursor-pointer">
                      ...
                      <v-list-item-title>
                        <NuxtLink to="/client/profile" class="text-slate-700 text-sm font-medium">
                          Profile
                        </NuxtLink>
                      </v-list-item-title>
                    </v-list-item>
                    ...
                    <v-list-item :ripple="false" class="hover:bg-red-50 px-2 py-1 cursor-pointer">
                      ...
                      <v-list-item-title>
                        <button class="text-red-500 text-sm font-medium" @click="logout">
                          Sign Out
                        </button>
                      </v-list-item-title>
                    </v-list-item>
...
import Boarders from "~/pages/client/boarders.vue";
...
const routeTitles: Record<string, string> = {
  ...
  '/client/boarders': 'Boarders Management',
  '/client/rooms': 'Room Assignments',
  '/client/payments': 'Payments & Billing',
  '/client/reports': 'Records & Reports',
...
const isActive = (path: string) => {
  ...
  if (target !== '/client' && current.startsWith(target)) return true
  return false
}
